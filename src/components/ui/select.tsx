...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-9 w-full items-center justify-between gap-2 rounded-[0.125rem] border px-3 py-2 text-sm outline-none disabled:cursor-not-allowed disabled:opacity-50',
      className
    )}
    style={{
